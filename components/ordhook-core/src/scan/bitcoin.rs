...
pub async fn scan_bitcoin_chainstate_via_rpc_using_predicate(
    ...
    while let Some(current_block_height) = block_heights_to_scan.pop_front() {
        ...
        // Q: 这个get_any_entry_in_ordinal_activities是干嘛的？
        // A: 用于检查当前区块高度是否已经被扫描过
        ...
        .await?;
        // 下载并解析区块
        // see: https://developer.bitcoin.org/reference/rpc/getblock.html#result-for-verbosity-2
        let block_breakdown =
